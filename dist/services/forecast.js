...
exports.projectBalanceTimeline = projectBalanceTimeline;
function projectBalanceTimeline(startDate, endDate, accounts, bills, incomeSources, dailySpendBuffer = 0) {
    const timeline = [];
    ...
    incomeSources.forEach(income => {
        const payDates = generateIncomeDates(income.next_pay_date || startDate, income.frequency, startDate, endDate);
...
function generateIncomeDates(startDate, frequency, rangeStart, rangeEnd) {
    const dates = [];
...
// }
function generateIncomeDates2(income, start, end) {
    const dates = [];
